...
def create_boolean_network_graph(selected, data, method, displacement, thr_k, thr_o, thr_s, thr_b):
    ...
    network = pd.DataFrame(create_boolean_network(selected, method, data, displacement, thr_k, thr_o, thr_s, thr_b))
...
# graph of final vote 
# arguments: selected - rows to create network, methods - method to create network, data - dataset, tolerance - number of iterations
def create_boolean_network_graph_votes(selected, data, methods, displacement, thr_k, thr_o, thr_s, thr_b):
    
    # get the dataframe of the network based on the final vote of all algorithms 
    final = pd.DataFrame(create_boolean_network_votes(selected, data, methods, displacement, thr_k, thr_o, thr_s, thr_b))
