...
from inference_methods.BooleanModeling2post.boolean2 import util

# require python 2.4 or higher
if sys.version_info[:2] < (2, 5):
    util.error("this program requires python 2.5 or higher" )

from inference_methods.BooleanModeling2post.boolean2 import ruleparser, boolmodel, timemodel, tokenizer

from inference_methods.BooleanModeling2post.boolean2.tokenizer import modify_states
