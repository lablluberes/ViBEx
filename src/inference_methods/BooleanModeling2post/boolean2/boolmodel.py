...
from inference_methods.BooleanModeling2post.boolean2.ruleparser import Parser
from inference_methods.BooleanModeling2post.boolean2 import tokenizer, util, state
